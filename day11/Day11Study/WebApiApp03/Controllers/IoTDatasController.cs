    ...
    public class IoTDatasController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<iot_datas>>> GetIoTDatas(string serviceKey, string startDate, string endDate, string resultType)
        {
            ...
            } else if (resultType == "json")
            {
                ...
                return null;// _context.iot_datas.ToListAsync();
        }
        ...
        //{
        //    _context.iotdatas.Add(ioTDatas);
        //    await _context.SaveChangesAsync();
        ...
        //{
        //    var ioTDatas = await _context.iotdatas.FindAsync(id);
        //    if (ioTDatas == null)
        //    {
        //        return NotFound();
        //    }

        //    _context.iotdatas.Remove(ioTDatas);
        //    await _context.SaveChangesAsync();
        ...
        //{
        //    return _context.iotdatas.Any(e => e.Id == id);
        //}
    }
}
